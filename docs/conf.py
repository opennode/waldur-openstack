...
# -*- coding: utf-8 -*-
#
# Waldur OpenStack documentation build configuration file.
#
...
from waldur_openstack import __version__
...
htmlhelp_basename = 'waldur-openstackdoc'
...
latex_documents = [
  ('index', 'waldur-openstack.tex', u'Waldur OpenStack Documentation',
   u'OpenNode', 'manual'),
]
