...
def register_in(router):
    ...
    router.register(r'openstacktenant-images-overview', views.ImageOverviewViewSet, base_name='openstacktenant-image-overview')
    router.register(r'openstacktenant-flavors', views.FlavorViewSet, base_name='openstacktenant-flavor')
    router.register(r'openstacktenant-flavors-overview', views.FlavorOverviewViewSet, base_name='openstacktenant-flavor-overview')
