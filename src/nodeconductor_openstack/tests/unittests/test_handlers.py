...
class FloatingIpHandlersTest(TestCase):
    ...
    def test_floating_ip_count_quota_increases_on_floating_ip_creation(self):
        ...
        self.assertEqual(floating_ip.service_project_link.tenant.quotas.get(name='floating_ip_count').usage, 1)
    ...
    def test_floating_ip_count_quota_changes_on_floating_ip_status_change(self):
        ...
        self.assertEqual(floating_ip.service_project_link.tenant.quotas.get(name='floating_ip_count').usage, 0)
