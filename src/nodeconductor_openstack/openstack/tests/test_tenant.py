...
class TenantGetTest(BaseTenantActionsTest):
    ...
    @override_openstack_settings(AUTOGENERATE_TENANT_CREDENTIALS=True)
    def test_user_name_and_password_and_access_url_are_not_returned_if_autogeneration_is_enabled(self):
        self.client.force_authenticate(self.fixture.staff)
    ...
    def test_user_name_and_password_and_access_url_are_returned_if_autogeneration_is_disabled(self):
        ...
        self.assertIn('user_password', response.data)
        self.assertIn(self.fixture.openstack_service_settings.backend_url, response.data['access_url'])
...
class TenantCreateTest(BaseTenantActionsTest):
    ...
    @override_openstack_settings(AUTOGENERATE_TENANT_CREDENTIALS=True)
    def test_user_name_and_password_are_autogenerated_if_autogeneration_is_configured(self):
        self.client.force_authenticate(self.fixture.staff)
