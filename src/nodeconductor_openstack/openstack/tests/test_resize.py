...
class ResizeInstanceTestCase(test.APITransactionTestCase):
    ...
    def test_user_with_access_can_change_flavor_of_stopped_instance(self, user):
        ...
        self.assertEqual(reread_instance.system_volume_size, self.instance.system_volume_size,
    ...
    def test_user_with_access_cannot_change_flavor_of_stopped_instance_if_quota_would_be_exceeded(self, user):
        ...
        big_ram_flavor = factories.FlavorFactory(
            settings=self.fixture.openstack_service_settings,
            ram=tenant.quotas.get(name='ram').limit + self.instance.ram + 1,
        )
        ...
        many_core_flavor = factories.FlavorFactory(
            settings=self.fixture.openstack_service_settings,
            cores=tenant.quotas.get(name='vcpu').limit + self.instance.cores + 1,
        )
